...
class Client(object):
    ...
    def postJsonHelper(self,
        ...
        response = requests.post(self.apiAddress + url,
                                 data=input_json,
                                 headers=headers,
    ...
    def getHelper(self, url, **query_parameters):
        ...
        if self.apiKey is not None:
            headers['Authorization'] = self.apiKey
        return requests.get(self.apiAddress + url,
                            headers=headers,
                            params=query_parameters)
    ...
    def patchHelper(self, url, params):
        ...
        if self.apiKey is not None:
            headers['Authorization'] = self.apiKey
        return requests.patch(self.apiAddress + url,
                              headers=headers,
    ...
    def headHelper(self, url):
        ...
        if self.apiKey is not None:
            headers['Authorization'] = self.apiKey
        return requests.head(self.apiAddress + url,
                             headers=headers)
    ...
    def putHelper(self, url, data):
        ...
        if self.apiKey is not None:
            headers['Authorization'] = self.apiKey
        response = requests.put(self.apiAddress + url,
                                data=data,
                                headers=headers)
        return response.json()
    ...
    def deleteHelper(self, url):
        ...
        if self.apiKey is not None:
            headers['Authorization'] = self.apiKey
        response = requests.delete(self.apiAddress + url,
                                   headers=headers)
        return response.json()
